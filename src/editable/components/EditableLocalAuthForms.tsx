...
const inputClass = 'h-[3.25rem] rounded-2xl border border-black/10 bg-[#f0eef3] px-4 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-[#6b00f5] focus:bg-white'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[#6b00f5] px-6 text-xs font-black uppercase tracking-[0.2em] text-white shadow-[0_16px_35px_rgba(107,0,245,.22)] transition hover:bg-black disabled:opacity-60'
